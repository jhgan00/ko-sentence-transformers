...
if matryoshka_dims:
    nli_train_loss = losses.MatryoshkaLoss(
        model, nli_train_loss,
        matryoshka_dims=matryoshka_dims,
        matryoshka_weights=matryoshka_weights,
    )
    sts_train_loss = losses.MatryoshkaLoss(
        model, sts_train_loss,
        matryoshka_dims=matryoshka_dims,
        matryoshka_weights=matryoshka_weights,
    )
    dev_evaluator = SequentialEvaluator([
        EmbeddingSimilarityEvaluator.from_input_examples(
            dev_samples, batch_size=args.sts_batch_size,
